...
@Component({
  selector: 'app-intervention-request-detail',
  templateUrl: './intervention-request-detail.component.html',
  styleUrl: './intervention-request-detail.component.scss'
})
export class InterventionRequestDetailComponent implements OnInit{
