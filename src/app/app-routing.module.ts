...
import {
  InterventionRequestDetailComponent
} from "./pages/intervention-request/intervention-request-detail/intervention-request-detail.component";
...
export const routes: Routes = [
  ...
  {
    path:'intervention-request-detail', component:
    InterventionRequestDetailComponent
  },
  {
